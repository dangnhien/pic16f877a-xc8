# 1 "libraryUser/rtc-ds1307/rtc-ds1307.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "libraryUser/rtc-ds1307/rtc-ds1307.c" 2
# 1 "libraryUser/rtc-ds1307/rtc-ds1307.h" 1
# 15 "libraryUser/rtc-ds1307/rtc-ds1307.h"
...
# 15 "libraryUser/rtc-ds1307/rtc-ds1307.h" 2
...
# 16 "libraryUser/rtc-ds1307/rtc-ds1307.h" 2
...
# 17 "libraryUser/rtc-ds1307/rtc-ds1307.h" 2
...
# 18 "libraryUser/rtc-ds1307/rtc-ds1307.h" 2

# 1 "libraryUser/rtc-ds1307/./../i2c-mater/i2c-master.h" 1
# 16 "libraryUser/rtc-ds1307/./../i2c-mater/i2c-master.h"
...
# 16 "libraryUser/rtc-ds1307/./../i2c-mater/i2c-master.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c90\\stdint.h" 1 3
# 17 "libraryUser/rtc-ds1307/./../i2c-mater/i2c-master.h" 2
...
# 19 "libraryUser/rtc-ds1307/rtc-ds1307.h" 2
# 47 "libraryUser/rtc-ds1307/rtc-ds1307.h"
typedef enum
{
  OUT_OFF = 0x00,
  OUT_ON = 0x80,
...
# 33 "libraryUser/rtc-ds1307/rtc-ds1307.c"
void RTC_Set(Times *time_t)
{
  uint8_t sec_register = RTC_Read_Register(0x00);
  ...
  I2C_Write_Char(0xD0);
  I2C_Write_Char(0x00);
  I2C_Write_Char(time_t->seconds);
  I2C_Write_Char(time_t->minutes);
  I2C_Write_Char(time_t->hours);
  I2C_Write_Char(time_t->weekdays);
  I2C_Write_Char(time_t->day);
  I2C_Write_Char(time_t->month);
  I2C_Write_Char(time_t->year);
  I2C_Stop();
...
Times *RTC_Get()
{
  ...
  I2C_Write_Char(0xD0 | 0x01);


  c_time.seconds = I2C_Read_Char(0) & 0x7F;
  c_time.minutes = I2C_Read_Char(0);
  c_time.hours = I2C_Read_Char(0);
  c_time.weekdays= I2C_Read_Char(0);
  c_time.day = I2C_Read_Char(0);
  c_time.month = I2C_Read_Char(0);
  c_time.year = I2C_Read_Char(1);
...
void RTC_Write_Register(uint8_t register_address, uint8_t register_value)
{
  I2C_Start();
  I2C_Write_Char(0xD0);
  I2C_Write_Char(register_address);
  I2C_Write_Char(register_value);
  I2C_Stop();
}
...
# 164 "libraryUser/rtc-ds1307/rtc-ds1307.c"
void Frequency_Set(Frequency pin_out)
{
  I2C_Start();
  I2C_Write_Char(0xD0);
  I2C_Write_Char(0x07);
  I2C_Write_Char(pin_out);
  I2C_Stop();
}
...
void Oscillator_Enable()
{
  ...
  sec_register &= 0x7F;
  RTC_Write_Register(0x00, sec_register);
}
