# 1 "libraryUser/i2c/i2c-master.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "libraryUser/i2c/i2c-master.c" 2
# 1 "libraryUser/i2c/i2c-master.h" 1
# 14 "libraryUser/i2c/i2c-master.h"
...
# 14 "libraryUser/i2c/i2c-master.h" 2
...
# 15 "libraryUser/i2c/i2c-master.h" 2
...
# 16 "libraryUser/i2c/i2c-master.h" 2
...
# 17 "libraryUser/i2c/i2c-master.h" 2
# 40 "libraryUser/i2c/i2c-master.h"
...
void I2C_Master_Init(const unsigned long I2C_BaudRate)
{
 ...
 SSPSTAT = 0x80;
 SSPADD = (unsigned char)( 16000000/(4*I2C_BaudRate) ) - 1;


 TRISCbits.TRISC3 = 1;
 TRISCbits.TRISC4 = 1;
}
# 27 "libraryUser/i2c/i2c-master.c"
void I2C_Wait()
{
